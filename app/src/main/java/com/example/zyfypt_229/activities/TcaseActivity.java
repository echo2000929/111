...
public class TcaseActivity extends AppCompatActivity {
    private int resid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tcase);
        context=TcaseActivity.this;

        resid  = getIntent().getIntExtra("resid",1);

        webView4 = findViewById(R.id.webView4);
        if (webView4==null){
            Timber.i("webview is null");
        } else {
            Timber.i("webview is not null");
        }
        webView4.loadUrl(Common.TCASEURL+resid);
