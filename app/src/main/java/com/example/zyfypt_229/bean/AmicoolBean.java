...
/**
 * Created by Neusoft on 2016/12/20.
 */

public class AmicoolBean {
    private int id;
    private String name;
    ...
    public void setTechnoid(int technoid) {
    ...
    public int getCheck_userid() {
        return check_userid;
    }

    public void setCheck_userid(int check_userid) {
