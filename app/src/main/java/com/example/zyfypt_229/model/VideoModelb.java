...
import com.example.zyfypt_229.service.VideoService2;
...
public class VideoModelb implements VideoIface {
    ...
    public void getResultList(String mod, int page, String sessionID, final VideoListener videoListener) {
        //使用Retrofit----2
        VideoService2 service
                =retrofit.create(VideoService2.class);
